...
```{r fig-s4-gardnerella-vag, fig.width=8, fig.height=4, echo=FALSE}
...
## Uncomment next line to save as a PDF
# ggsave("supplemental/fig-s4-gardnerella-vag.pdf", width=8, height=4, units="in")
```
...
```{r fig-s5-tanner-correlations, fig.width=10, fig.height=10, echo=FALSE}
...
# pdf("supplemental/fig-s5-tanner-correlations.pdf", width=10, height=10)
...
```{r fig-s6-lab-ph, fig.width=8, fig.height=6, echo=FALSE}
## LAB vs. ph
