...
```{r hclust-silhouette, fig.width=8, fig.height=6}
...
```{r fig-s7-hclust-heatmap-hellinger-bray-upgma, fig.width=12, fig.height=8}
...
```{r pcoa-vag-vul-hclust, fig.width=8, fig.height=8}
...
```{r vag-vul-pearson, fig.width=8, fig.height=6}
